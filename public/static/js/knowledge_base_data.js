export const STATIC_QA_DATA = [
    // SECCIÓN 1 — Preguntas generales básicas
    {
        "q": "¿Quién eres?",
        "a": "Soy una IA integrada en este curso de Python. Estoy aquí para ayudarte a entender el ejercicio en el que estás y guiarte paso a paso mientras practicas."
    },
    {
        "q": "¿Cómo te llamas?",
        "a": "Soy tu asistente de Python dentro del curso. Mi nombre cambia según la sección, pero siempre estoy aquí para ayudarte."
    },
    {
        "q": "¿Qué haces?",
        "a": "Te explico los ejercicios, aclaro dudas, doy pistas y reviso lo que estás aprendiendo en el módulo actual."
    },
    {
        "q": "¿Cuál es tu función en este curso?",
        "a": "Mi función es acompañarte en cada ejercicio, ayudarte a comprender el código y resolver tus dudas sin que tengas que pegar nada: yo ya veo lo que estás haciendo."
    },
    {
        "q": "¿A qué te dedicas exactamente?",
        "a": "Me dedico a guiarte en el aprendizaje de Python, explicando conceptos, corrigiendo errores y dándote ejemplos cuando lo necesites."
    },
    {
        "q": "¿Qué tal estás?",
        "a": "¡Listo para ayudarte con este ejercicio! Cuando quieras, pregúntame lo que necesites."
    },
    {
        "q": "Háblame de ti.",
        "a": "Soy un asistente creado para este curso. Mi especialidad es darte explicaciones rápidas, claras y adaptadas al ejercicio actual."
    },
    {
        "q": "Cuéntame algo.",
        "a": "¿Sabías que Python fue creado como un lenguaje simple y legible? Por eso es perfecto para aprender programación, justo como lo estás haciendo ahora."
    },
    {
        "q": "Cuéntame un chiste.",
        "a": "¿Por qué el programador no puede salir de la ducha?\nPorque el champú dice “aplica, enjuaga y repite”. 😄"
    },
    {
        "q": "Explícame qué estás viendo exactamente.",
        "a": "Estoy viendo el ejercicio del módulo en el que estás ahora, incluyendo el código y las instrucciones oficiales."
    },

    // SECCIÓN 2 — Preguntas sobre el ejercicio (genéricas para cualquier módulo)
    {
        "q": "¿De qué trata este ejercicio?",
        "a": "Este ejercicio está diseñado para practicar el concepto principal del módulo, aplicándolo directamente en el código que ya tienes visible."
    },
    {
        "q": "¿Cuál es el objetivo del ejercicio?",
        "a": "Que puedas comprender y aplicar la idea central: puede ser variables, funciones, bucles, listas, automatización o cualquier tema del módulo en curso."
    },
    {
        "q": "¿Para qué sirve este ejercicio?",
        "a": "Sirve para reforzar la teoría mediante práctica guiada, usando un ejemplo real dentro del editor."
    },
    {
        "q": "Resúmeme este ejercicio.",
        "a": "En este ejercicio debes ejecutar el código, observar su resultado y entender cómo se relaciona con el concepto explicado en este módulo."
    },
    {
        "q": "¿Qué tengo que hacer exactamente?",
        "a": "Sigue las indicaciones que aparecen justo encima del código: suelen pedirte leer, ejecutar, modificar o analizar algo."
    },
    {
        "q": "¿Cuál es la parte más importante del ejercicio?",
        "a": "La parte clave es entender cómo funciona el bloque de código que estás viendo y cómo se relaciona con el tema que estás aprendiendo."
    },
    {
        "q": "Dame una pista sin decirme la solución.",
        "a": "Piensa en cómo funciona este concepto en Python y qué efecto tiene en el código que estás viendo."
    },
    {
        "q": "¿Está bien lo que hice?",
        "a": "Yo puedo ver tu ejercicio actual, así que si necesitas, puedo revisar la lógica y comentarte si va en la dirección correcta."
    },
    {
        "q": "¿Me puedes explicar paso a paso el ejercicio?",
        "a": "Claro: puedo desglosarlo en partes sencillas y seguirte en cada paso sin que tengas que copiar nada."
    },
    {
        "q": "¿Qué hago ahora?",
        "a": "Sigue la siguiente instrucción marcada en el ejercicio, o pregúntame por la parte en la que tengas dudas."
    },

    // SECCIÓN 3 — Interacciones rápidas (para el chat express)
    {
        "q": "Dime la teoría básica de este ejercicio.",
        "a": "La teoría principal aquí es comprender cómo funciona este concepto de Python y cómo se refleja en el código que tienes en pantalla."
    },
    {
        "q": "Dame una explicación rápida.",
        "a": "Este ejercicio te muestra un ejemplo práctico del concepto del módulo. Observa qué hace el código, ejecútalo y detecta la relación con la teoría."
    },
    {
        "q": "Respuesta corta: ¿qué hace este código?",
        "a": "Realiza exactamente la acción que ves en pantalla, basada en el tema del ejercicio (variables, bucles, funciones, etc.)."
    },
    {
        "q": "Dame un consejo para este tipo de ejercicios.",
        "a": "Siempre analiza primero qué pretende demostrar el código antes de modificarlo."
    },
    {
        "q": "Estoy perdido.",
        "a": "No te preocupes, puedo guiarte. Dime qué parte del ejercicio quieres entender mejor y te la explico de forma clara."
    },

    // SECCIÓN 4 — Módulo 00 (Bienvenida y Herramientas)
    {
        "q": "¿Qué es el Módulo 00?",
        "a": "Es la bienvenida. Configuras tu entorno y conoces la filosofía hacker del curso."
    },
    {
        "q": "¿Qué herramientas necesito?",
        "a": "Recomiendo VSCode, PyCharm o Thonny. Lo vital es experimentar y no tener miedo a romper el código."
    },
    {
        "q": "¿Qué es PythonSecOS?",
        "a": "Es la simulación inmersiva del curso. Un 'sistema operativo' donde entrenarás tus habilidades de ciberseguridad."
    },
    {
        "q": "¿Qué voy a aprender?",
        "a": "Python desde cero hasta scripts de automatización, herramientas de hacking ético y análisis forense."
    },
    {
        "q": "¿Cómo empiezo?",
        "a": "Lee la guía en el editor y pulsa 'Ejecutar' para iniciar el protocolo de bienvenida."
    },

    // SECCIÓN 5 — Módulo 01 (Introducción)
    {
        "q": "¿Qué es print()?",
        "a": "Es la función para mostrar texto o resultados en la consola. Ejemplo: `print('Hola')`."
    },
    {
        "q": "¿Qué son las variables?",
        "a": "Son contenedores para guardar datos. Se crean asignando un valor: `nombre = 'Carlos'`."
    },
    {
        "q": "¿Cuáles son los tipos de datos básicos?",
    ...
    {
        "q": "¿Qué es un int?",
        "a": "Es un número entero (sin decimales), como `10`, `0` o `-5`."
    },
    {
        "q": "¿Qué es un float?",
        "a": "Es un número decimal (punto flotante), como `3.14` o `2.5`."
    },
    {
        "q": "¿Qué es un boolean?",
    ...
    {
        "q": "¿Qué es una lista?",
        "a": "Es una colección ordenada de elementos. Se usa corchetes: `[1, 2, 3]`."
    },
    {
        "q": "¿Cómo pido datos al usuario?",
        "a": "Usa la función `input()`. Ejemplo: `nombre = input('¿Tu nombre?')`."
    },
    {
        "q": "¿Qué es el casting?",
        "a": "Es convertir un tipo de dato a otro. Ejemplo: `int('5')` convierte el texto '5' al número 5."
    },
    {
        "q": "¿Cómo comento el código?",
        "a": "Usa `#` para comentarios de una línea. Python ignorará todo lo que escribas después."
    },

    // SECCIÓN 6 — FAQ General Python
    {
        "q": "¿Existe un depurador a nivel de código fuente con puntos de interrupción, depuración paso a paso, etc?",
    ...
    {
        "q": "¿Existe alguna herramienta que ayude a encontrar errores o realizar análisis estático?",
    ...
    {
        "q": "¿Qué hace la barra (/) en medio de la lista de parámetros de una función?",
    ...
    {
        "q": "¿Cómo convierto una cadena a un número?",
    ...
    {
        "q": "¿Cómo puedo convertir un número a una cadena?",
    ...
    {
        "q": "¿Cómo puedo modificar una cadena in situ?",
        "a": "No puedes debido a que las cadenas son inmutables. En la mayoría de situaciones solo deberías crear una nueva cadena a partir de varias partes que quieras usar para crearla. Sin embargo, si necesitas un objeto con la habilidad de modificar en el mismo lugar datos unicode prueba usando el objeto io.StringIO o el módulo array:\nimport io\ns = \"Hello, world\"\nsio = io.StringIO(s)\nsio.getvalue()\n'Hello, world'\nsio.seek(7)\n7\nsio.write(\"there!\")\n6\nsio.getvalue()\n'Hello, there!'\nimport array\na = array.array('w', s)\nprint(a)\narray('w', 'Hello, world')\na[0] = 'y'\nprint(a)\narray('w', 'yello, world')\na.tounicode()\n'yello, world'"
    },
    {
        "q": "¿Cómo puedo usar cadenas para invocar funciones/métodos?",
        "a": "Existen varias técnicas.\nLo mejor sería usar un diccionario que mapee cadenas a funciones. La principal ventaja de esta técnica es que las cadenas no necesitan ser iguales que los nombres de las funciones. Esta es también la principal técnica que se usa para emular un constructo case:\ndef a():\npass\ndef b():\npass\ndispatch = {'go': a, 'stop': b}  # Note lack of parens for funcs\ndispatch[get_input()]()  # Note trailing parens to call function\nUsa la función incorporada getattr():\nimport foo\ngetattr(foo, 'bar')()\nNótese que getattr() funciona en cualquier objeto, incluido clases, instancias de clases, módulos, etc.\nEsto se usa en varios lugares de la biblioteca estándar, como esto:\nclass Foo:\ndef do_foo(self):\n...\ndef do_bar(self):\n...\nf = getattr(foo_instance, 'do_' + opname)\nf()\nUse locals() para resolver el nombre de la función:\ndef myFunc():\nprint(\"hello\")\nfname = \"myFunc\"\nf = locals()[fname]\nf()"
    },
    {
        "q": "Is there an equivalent to Perl’s chomp() for removing trailing newlines from strings?",
    ...
    {
        "q": "¿Cómo puedo crear una lista multidimensional?",
    ...
    {
        "q": "¿Cuándo puedo fiarme de pruebas de identidad con el operador is?",
    ...
    {
        "q": "¿Cómo puede una subclase controlar qué datos se almacenan en una instancia inmutable?",
