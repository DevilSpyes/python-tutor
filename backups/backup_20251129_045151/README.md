...
### 2. 📂 Modo Local Offline (Privacidad Total)
**Ideal para uso sin internet.**
*   **Cómo funciona:** Usa modelos ligeros (Qwen 0.5B) directamente en tu navegador.
*   **Privacidad:** Tus datos nunca salen de tu dispositivo.
*   **Requisitos:** Puede ser más lento en dispositivos antiguos.
